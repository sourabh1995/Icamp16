...
<html>
    <head>
        <title>Photo Gallery 2015</title>
  ...
  <link href="css/slidertext.css" type="text/css" rel="stylesheet" media="screen,projection"/>
  <link href='https://fonts.googleapis.com/css?family=Open+Sans:300' rel='stylesheet' type='text/css'>
        <style>
			...
			h1.title{
				...
				left:10px;
				text-indent:-9000px;
				background:transparent url(img/icons/title.png) no-repeat top left;
				z-index:2;
			}
		</style>
    ...
    <body>
		...
		<div id="fp_gallery" class="fp_gallery">
			<img src="img/1.jpg" alt="" class="fp_preview" style="display:none;"/>
			...
			<div id="outer_container">
				<div id="thumbScroller">
					<div class="container">
						<div class="content">
							<div><a href="#"><img src="img/1.jpg" alt="img/1.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/2.jpg" alt="img/2.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/3.jpg" alt="img/3.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/4.jpg" alt="img/4.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/5.jpg" alt="img/5.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/6.jpg" alt="img/6.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/7.jpg" alt="img/7.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/8.jpg" alt="img/8.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/9.jpg" alt="img/9.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/10.jpg" alt="img/10.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/11.jpg" alt="img/11.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/12.jpg" alt="img/12.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/13.jpg" alt="img/13.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/14.jpg" alt="img/14.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/15.jpg" alt="img/15.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/16.jpg" alt="img/16.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/17.jpg" alt="img/17.jpg" class="thumb" /></a></div>
						</div>
						<div class="content">
							<div><a href="#"><img src="img/18.jpg" alt="img/18.jpg" class="thumb" /></a></div>
						</div>
					</div>
				</div>
			</div>
        ...
        <script type="text/javascript">
            $(function() {
				...
				$thumbScroller.find('.content').bind('click',function(e){
					...
					function(){
						...
						$('<img class="fp_preview"/>').load(function(){
							...
							//now we have two large img on the page
				...
				function showThumbs(speed){
					$('#outer_container').stop().animate({'bottom':'300px'},speed);
					hideThumbsBtn();
				}
				...
				//events for navigating through the set of img
